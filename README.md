...
<body>
  ...
  <h1 class="site-heading text-center text-red d-none d-lg-block">
    <span class="site-heading-upper text-primary mb-3">We sell all the korea products</span>
  </h1>

  <h2 class="site-heading text-center text-red  d-lg-block">
     <span class="site-heading-upper text-primary mb-3">Korea Family Market</span>
    </h2>
  ...
  <section class="page-section clearfix">
    <div class="container">
      <div class="intro">
        <img src="src/intro.jpg" alt="Image" class="img-fluid" style="width:1000px;height:600px;">
        <div class="intro-text left-0 text-center bg-faded p-5 rounded">
          <h2 class="section-heading mb-4">
            <span class="section-heading-upper">Are you willing to</span>
            <span class="section-heading-lower">buy Korea products?</span>
          </h2>
  ...
  <footer class="footer text-faded text-center py-5">
    <div class="container">
      <p class="m-0 small">Copyright &copy; Korea Family Market 2020</p>
    </div>
  </footer>
